...
```{r}
      ...
      ############## Executing the function with annotation and chromosome data ###########
...
Annotated_Df #loading the final data
...
```{r}
     ...
     ########## CONCLUSION BASED ON THE ANNOTATED DATA ##########################
...
#properly parsed with informations.Further,Attributes were tidied to parse more detailed 
#information about the chromosome and coordinates like the gene and exon details.Annotation could be done in several other programming tools.SInce a lot of powerful packages like dplyr for filtering and joining,stringr for parsing and for performing exploratory data analysis are present in R,I chose to solve this problem in R in a more straightforward and efficient way.
